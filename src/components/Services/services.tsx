			...
			<div className={styles.container}>
				<div className={styles.header}>
					...
					<p className={styles.subtitle}>
						Comprehensive support services to keep your equipment running at
						peak performance.
					</p>
				</div>
				...
				<div className={styles.servicesGrid}>
					<div className={styles.serviceCard}>
						...
						<p className={styles.serviceDescription}>
							Expert maintenance and repair services to maximize equipment
							uptime and extend operational life.
						</p>
					</div>
            ...
            <p className={styles.serviceDescription}>
              Round-the-clock emergency support to minimize downtime and keep your projects on schedule.
					...
					<div className={styles.serviceCard}>
						...
						<p className={styles.serviceDescription}>
							Comprehensive warranty programs to protect your investment and
					...
					<div className={styles.serviceCard}>
						...
						<h3 className={styles.serviceTitle}>Sales Support</h3>
						<p className={styles.serviceDescription}>
							Expert technical guidance and product support from our experienced
							team.
						</p>
					</div>
				</div>
